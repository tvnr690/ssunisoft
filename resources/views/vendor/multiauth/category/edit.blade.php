                            ...
                            <form method="POST" action="{{ route('admin.category.update', $category->id) }}">
                                ...
                                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="cat_name" type="text" class="form-control" name="cat_name" value="{{ $category->cat_name }}"
                                            required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group{{ $errors->has('cat_slug') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="cat_slug" type="text" class="form-control" name="cat_slug" value="{{ $category->cat_slug }}"
                                                required>
                                        </div>
                                    </div>
                                </fieldset>
