                            ...
                            <form method="POST" action="{{ route('admin.tag.update', $tag->id) }}">
                                ...
                                <fieldset class="mb-3">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="tag_name" type="text" class="form-control" name="tag_name" value="{{ $tag->tag_name }}"
                                            required autofocus>
                                        </div>
                                    </div>
                                    <div class="form-group{{ $errors->has('tag_slug') ? ' has-error' : '' }} row">
                                        ...
                                        <div class="col-lg-10">
                                            <input id="tag_slug" type="text" class="form-control" name="tag_slug" value="{{ $tag->tag_slug }}"
                                                required>
                                        </div>
                                    </div>
                                </fieldset>
