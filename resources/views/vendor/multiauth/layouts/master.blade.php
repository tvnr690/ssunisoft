...
<body>
	...
	<div class="navbar navbar-expand-md navbar-dark">
		<div class="navbar-brand">
            ...
            <a class="d-inline-block" href="{{ route('admin.home') }}">
                {{-- <h3>{{ config('app.name', 'Laravel') }} {{ ucfirst(config('multiauth.prefix')) }}</h3> --}}
                <img src="{{ asset('global_assets/images/logo_light.png') }}" alt="">
            </a>
		</div>
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item dropdown dropdown-user">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a href="{{ route('admin.password.change') }}" class="dropdown-item"><i class="icon-cog5"></i> Change Password</a>
                        <a href="#" class="dropdown-item" href="/admin/logout" onclick="event.preventDefault();
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
                        ...
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-user-lock"></i> <span>Admin Roles</span></a>
                            <ul class="nav nav-group-sub" data-submenu-title="JSON forms">
                                <li class="nav-item"><a href="{{ route('admin.roles') }}" class="nav-link">All Roles</a></li>
                                <li class="nav-item"><a href="{{ route('admin.role.create') }}" class="nav-link">New Role</a></li>
                            </ul>
                        </li>
                        <li class="nav-item nav-item-submenu">
                            <a href="#" class="nav-link"><i class="icon-user-plus"></i> <span>Admins</span></a>
                            <ul class="nav nav-group-sub" data-submenu-title="JSON forms">
                                <li class="nav-item"><a href="{{ route('admin.show') }}" class="nav-link">All Admins</a></li>
	...
	<div class="navbar navbar-expand-lg navbar-light">
		...
		<div class="navbar-collapse collapse" id="navbar-footer">
			<span class="navbar-text ml-lg-auto">
				&copy; {{ date('Y') }} <a href="#">SSUnisoft</a> by <a href="" target="_blank">Venkat Reddy</a>
			</span>
		</div>
	</div>
	<!-- /footer -->
